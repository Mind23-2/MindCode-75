...
function infer()
{
    ...
    ../ascend310_infer/out/main --model_path1=$model1 --model_path2=$model2  --device_id=$device_id --device_target=$5 --seq_root_path=$seq_root_path --code_path=$code_path &>infer.log
